...
This file tracks every figure and table produced in this project. It records what data was used, how it was generated, and where it appears (or is intended to appear).

## How to use this file

Each entry links a visual output to its data source, generation method, and purpose. This ensures any figure can be reproduced, updated, or explained during peer review.
...
| ID | Title | Status | Intended section | Data source |
| --- | --- | --- | --- | --- |
| FIG-001 |  |  |  |  |
| TBL-001 |  |  |  |  |
