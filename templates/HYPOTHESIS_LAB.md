...
AI agents may add raw ideas, questions, discomforts, and speculative hypotheses here during normal work.

AI agents must not silently delete hypotheses or raw sparks.
...
The human must approve deletions and major merges.

Raw sparks may be deleted after approval.
Working hypotheses should usually be marked as `dropped` with a short reason rather than erased.
